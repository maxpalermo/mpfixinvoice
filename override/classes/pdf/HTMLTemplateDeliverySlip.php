...
class HTMLTemplateDeliverySlip extends HTMLTemplateDeliverySlipCore
{
     ...
     */
    public function __construct(OrderInvoiceCore $order_invoice, $smarty, $bulk_mode = false)
    {
        PrestaShopLoggerCore::addLog('Init construct');
        $this->order_invoice = $order_invoice;
        $this->order = new OrderCore((int)$this->order_invoice->id_order);
        ...
        $this->title = sprintf(HTMLTemplateDeliverySlipCore::l('%1$s%2$06d'), $prefix, $this->order_invoice->delivery_number);
        /**
         * GET FEE
         */
        ...
        PrestaShopLoggerCore::addLog('Construct teminated');
    }
    ...
    public function getHeader()
    {
        ...
        $this->smarty->assign(array('header' => HTMLTemplateInvoice::l('Delivery')));
    ...
    public function getContent2()
    {
        ...
        $tpls = array(
            ...
            'tax_tab' => $this->smarty->fetch($this->getTemplate('delivery-slip.tax-tab')),//$this->getTaxTabContent(),
            'payment_tab' => $this->smarty->fetch($this->getTemplate('delivery-slip.payment-tab')),
            'note_tab' => $this->smarty->fetch($this->getTemplate('delivery-slip.note-tab')),
            'total_tab' => $this->smarty->fetch($this->getTemplate('delivery-slip.total-tab')),
            'shipping_tab' => $this->smarty->fetch($this->getTemplate('delivery-slip.shipping-tab')),
        );
    ...
    private function getDetailTaxes()
    {
        ...
        PrestaShopLoggerCore::addLog('Taxes:' . print_r($rows,1));
